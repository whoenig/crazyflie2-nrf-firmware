...
class _radio_ack:
	...
	def __repr__(self):
		return "Ack: {}, PowerDet: {}, retry: {}, data: {}".format(self.ack, self.powerDet, self.retry, self.data);
	...
	def __enter__(self):
		class RealCrazyradio:
			def __init__(self, devid):
				devices = []
				for d in usb.core.find(idVendor = CRADIO_VID, idProduct = CRADIO_PID, find_all=1):
					devices.append(d)
		...
		self.crazyradio = RealCrazyradio(self.devid)
